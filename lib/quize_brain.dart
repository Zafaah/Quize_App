...
class QuizBrain {
  ...
  void nextQuestion(){
    if(_questionNum<_questionresl.length-1){
      _questionNum++;
    }
  }
  String getQuestionText(){
    return _questionresl[_questionNum].questiontxt;
  }
  bool getCorrectAns(){
    return _questionresl[_questionNum].questionAns;
  }
